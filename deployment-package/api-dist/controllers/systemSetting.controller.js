...
export const systemSettingController = {
    upsertSetting: async (req, res) => {
        try {
            ...
            const setting = await systemSettingService.upsertSetting(companyId, validatedData.key, validatedData.value, validatedData.description);
...
//# sourceMappingURL=systemSetting.controller.js.map