...
export const chatwootController = {
     ...
     */
    syncConversations: async (req, res, next) => {
        try {
    ...
    getConversations: async (req, res, next) => {
        try {
            ...
            const chatwootConversations = conversations.filter((conv) => conv.platform === 'chatwoot');
     ...
     */
    getWebhookTest: async (req, res, next) => {
        try {
            ...
            const chatwootIntegrations = integrations.filter((i) => i.provider === 'chatwoot' && i.isActive);
...
//# sourceMappingURL=chatwoot.controller.js.map