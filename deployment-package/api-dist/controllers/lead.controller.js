...
export const leadController = {
    ...
    getAllLeads: async (req, res) => {
        try {
            ...
            if (req.query.interestId)
                filters.interestId = parseInt(req.query.interestId);
            if (req.query.search)
     ...
     */
    createLeadFromInbox: async (req, res) => {
        try {
    ...
    getClientLeads: async (req, res) => {
        try {
            ...
            if (req.query.campaignId) {
                filters.campaignId = parseInt(req.query.campaignId);
