    ...
    updateUser: async (req, res) => {
        try {
            ...
            if (validatedData.education !== undefined)
                updateData.education = validatedData.education || null;
            ...
            if (validatedData.eSignature !== undefined)
                updateData.eSignature = validatedData.eSignature || null;
            if (validatedData.designation !== undefined)
                updateData.designation = validatedData.designation || null;
            ...
            if (validatedData.salary !== undefined)
                updateData.salary = validatedData.salary || null;
            if (validatedData.workHours !== undefined)
                updateData.workHours = validatedData.workHours || null;
            if (validatedData.holidays !== undefined)
                updateData.holidays = validatedData.holidays || null;
            if (validatedData.bonus !== undefined)
                updateData.bonus = validatedData.bonus || null;
            if (validatedData.responsibilities !== undefined)
                updateData.responsibilities = validatedData.responsibilities || null;
