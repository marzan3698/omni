...
router.post('/', verifyPermission('can_manage_campaigns'), campaignController.createCampaign);
// Update campaign - SuperAdmin only
router.put('/:id', verifyPermission('can_manage_campaigns'), campaignController.updateCampaign);
// Delete campaign - SuperAdmin only
router.delete('/:id', verifyPermission('can_manage_campaigns'), campaignController.deleteCampaign);
