...
export const leadCallService = {
    async getLeadCalls(leadId, companyId) {
    ...
    async updateLeadCall(id, leadId, companyId, data) {
    ...
    async deleteLeadCall(id, leadId, companyId) {
        const call = await prisma.leadCall.findFirst({
            where: {
                id,
                leadId,
    ...
    async addCallNote(id, leadId, companyId, note) {
        const call = await prisma.leadCall.findFirst({
            where: {
                id,
                leadId,
     ...
     */
    async getAllCalls(companyId, userId, userRole, filters) {
        const where = {
            companyId,
        };
...
//# sourceMappingURL=leadCall.service.js.map