...
export const leadInterestService = {
    async createInterest(companyId, data) {
    ...
    async getInterestById(id, companyId) {
    ...
    async updateInterest(id, companyId, data) {
    ...
    async deleteInterest(id, companyId) {
        await this.getInterestById(id, companyId); // Verify exists
...
//# sourceMappingURL=leadInterest.service.js.map