...
export const taskConversationService = {
     ...
     */
    async markAsRead(messageId, userId, companyId) {
     ...
     */
    async markAllAsRead(conversationId, userId, companyId) {
        // Verify conversation exists and belongs to company
        const conversation = await prisma.taskConversation.findFirst({
            where: {
                id: conversationId,
     ...
     */
    async getUnreadCount(conversationId, userId, companyId) {
        // Verify conversation exists and belongs to company
        const conversation = await prisma.taskConversation.findFirst({
            where: {
                id: conversationId,
     ...
     */
    async getConversationByTaskId(taskId, companyId) {
        // Verify task exists and belongs to company
        const task = await prisma.task.findFirst({
            where: {
                id: taskId,
...
//# sourceMappingURL=taskConversation.service.js.map