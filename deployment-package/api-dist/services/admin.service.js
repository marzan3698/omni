...
export const adminService = {
        ...
        client.invoices.forEach((invoice) => {
            invoice.campaigns.forEach((campaignInvoice) => {
                ...
                campaign.leads.forEach((lead) => {
                    if (!campaignData.leads.find((l) => l.id === lead.id)) {
                ...
                campaign.groups.forEach((campaignGroup) => {
                    ...
                    if (!campaignData.employeeGroups.find((g) => g.id === groupId)) {
                    ...
                    group.members.forEach((member) => {
                        ...
                        if (!employeeData.groups.find((g) => g.id === groupId)) {
                        ...
                        if (!groupData.members.find((m) => m.id === employeeId)) {
    ...
    async getProjectById(id) {
        ...
        const totalEmployees = new Set(project.campaigns.flatMap((campaign) => campaign.groups.flatMap((cg) => cg.group.members.map((member) => member.employee.id)))).size;
        return {
            id: project.id,
            title: project.title,
