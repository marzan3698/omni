...
export const userService = {
    ...
    async updateUser(id, data, companyId) {
        ...
        if (data.eSignature !== undefined)
            updateData.eSignature = data.eSignature || null;
        ...
        if (data.designation !== undefined || data.department !== undefined ||
            ...
            if (data.department !== undefined)
                employeeData.department = data.department || null;
            if (data.salary !== undefined)
                employeeData.salary = data.salary || null;
            if (data.workHours !== undefined)
                employeeData.workHours = data.workHours || null;
            if (data.holidays !== undefined)
                employeeData.holidays = data.holidays || null;
            if (data.bonus !== undefined)
                employeeData.bonus = data.bonus || null;
            if (data.responsibilities !== undefined)
                employeeData.responsibilities = data.responsibilities || null;
            if (existingEmployee) {
