...
export const authService = {
    ...
    async registerClient(data) {
        ...
        const existingClient = await prisma.$queryRawUnsafe(`SELECT id FROM clients WHERE company_id = ? AND JSON_EXTRACT(contact_info, '$.email') = ? LIMIT 1`, defaultCompany.id, email.toLowerCase());
