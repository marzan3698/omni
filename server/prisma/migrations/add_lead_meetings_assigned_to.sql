-- Add assigned_to to lead_meetings (runs after add_lead_meetings - file renamed for correct order)
...
-- 4. Make NOT NULL only if no NULLs remain (safe when table empty or no employees)
...
-- 5. Add index (idempotent for MySQL)
SET @idx_exists = (
