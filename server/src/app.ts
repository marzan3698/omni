...
import leadPriorityRoutes from './routes/leadPriority.routes.js';
import leadLabelRoutes from './routes/leadLabel.routes.js';
import leadStatusConfigRoutes from './routes/leadStatusConfig.routes.js';
import { leadFormPublicRouter, leadFormConfigRouter } from './routes/leadFormConfig.routes.js';
...
app.use('/api/lead-labels', leadLabelRoutes);
app.use('/api/lead-statuses', leadStatusConfigRoutes);
app.use('/api/lead-form', leadFormPublicRouter);
app.use('/api/lead-form-config', leadFormConfigRouter);
