...
export const budgetService = {
   ...
   */
  async getAllBudgets(companyId: number) {
   ...
   * Get budget by ID
   */
  async getBudgetById(id: number, companyId: number) {
   ...
   */
  async calculateBudgetSpent(budgetId: number, startDate: Date, endDate: Date, categoryId?: number | null) {
   ...
   * Update budget
   */
  async updateBudget(id: number, companyId: number, data: UpdateBudgetData) {
    const budget = await prisma.budget.findFirst({
      where: {
        id,
        companyId,
   ...
   * Delete budget
   */
  async deleteBudget(id: number, companyId: number) {
    const budget = await prisma.budget.findFirst({
      where: {
        id,
        companyId,
