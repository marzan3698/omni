                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm">
                          <div className="flex items-center gap-2">
                            <Button
                              ...
                              className={isSuperAdmin ? 'h-8 px-3 bg-transparent border-amber-500/50 text-amber-100 hover:bg-amber-500/20 hover:text-amber-100' : 'h-8 px-3'}
                            >
                            ...
                            {isSuperAdmin && (
                              <Button
                                ...
                                className="h-8 px-3 bg-transparent border-amber-500/50 text-amber-100 hover:bg-amber-500/20 hover:text-amber-100"
                              >
